 ...
 *
 * The showcase template in Venture Lateral Bootstrap consists of a featured posts section using sticky posts,
			...
			<div id="content" role="main">
				...
				<div class="widget-area" role="complementary">
					<?php if ( ! dynamic_sidebar( 'sidebar-2' ) ) : ?>
						...
						<?php
						the_widget( 'ventureLateralBootstrap_Ephemera_Widget', '', array( 'before_title' => '<h3 class="widget-title">', 'after_title' => '</h3>' ) );
						?>
